...
void GlobalCoordsObtainer::generate_luts() {
  for (auto& global_constant : global_constants) {
    ...
    auto phi = calc_atan_lut(11,
			     6,
			     21./SEMICELL_IN_TDC_COUNTS/((global_constant.sl1.perp+global_constant.sl3.perp)/.2),
			     (global_constant.sl1.x_phi0-2.1*SL1_SEMICELL_OFFSET)/((global_constant.sl1.perp+global_constant.sl3.perp)/2),
			     1. / std::pow(2, 17),
			     9,
			     4,
			     11,
    ...
    auto phib = calc_atan_lut(9,
			      5,
			      21./SEMICELL_IN_TDC_COUNTS/(6.5*16),
			      0.,
			      4. / std::pow(2, 13),
			      9,
			      3,
