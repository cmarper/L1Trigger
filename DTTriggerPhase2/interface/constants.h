 ...
 */
  ...
  constexpr int X_SIZE = 17; //18;
  constexpr int TANPSI_SIZE = 14; //15;
  constexpr double PHI_SIZE = 1./pow(2,17); //1 rad range, 17 bits
  constexpr double PHIB_SIZE = 4./pow(2,13); //4 rad range, 13 bits

  constexpr int PHI_LUT_ADDR_WIDTH = 11; //12;
  constexpr int PHI_B_SHL_BITS = 5; //7;
  constexpr int PHI_MULT_SHR_BITS = 9; //10;
  constexpr int PHI_LUT_A_BITS = 11; //12;
  constexpr int PHI_LUT_B_BITS = 21; //20;

  constexpr int PHIB_LUT_ADDR_WIDTH = 9;
  constexpr int PHIB_B_SHL_BITS = 6; //7;
  constexpr int PHIB_MULT_SHR_BITS = 9; //10;
